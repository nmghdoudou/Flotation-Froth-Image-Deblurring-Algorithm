...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--dataroot', type=str, default='/home/datasets/float_images_2110/', help='path of data')
    self.parser.add_argument('--phase', type=str, default='train', help='phase for dataloading')
    self.parser.add_argument('--batch_size', type=int, default=2, help='batch size')
    self.parser.add_argument('--resize_size_x', type=int, default=256, help='resized image size for training,144 for face')
    self.parser.add_argument('--resize_size_y', type=int, default=256, help='resized image size for training')
    self.parser.add_argument('--crop_size', type=int, default=256, help='cropped image size for training, 128 for face')
    ...
    self.parser.add_argument('--display_dir', type=str, default='/home/work/udsd/logs', help='path for saving display results')
    ...
    self.parser.add_argument('--n_ep_decay', type=int, default=80, help='epoch start decay learning rate, set -1 if no decay')
    ...
    self.parser.add_argument('--lambdaB', type=float, default=0.5, help='perceptual loss weight for B')
    self.parser.add_argument('--lambdaI', type=float, default=0.05, help='perceptual loss weight for I')
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--dataroot', type=str, default='/home/datasets/float_images_2110/test_size/testB/', help='path of data')
    ...
    self.parser.add_argument('--name', type=str, default='trial', help='folder name to save outputs')
    self.parser.add_argument('--name_orig', type=str, default='orig', help='folder name to save outputs')
    self.parser.add_argument('--result_dir', type=str, default='./outputs', help='path for saving result images and models')

  
    self.parser.add_argument('--orig_dir', type=str, default='/home/datasets/float_images_2110/test_size/testA', help='path for saving result images and models')
    ...
    self.parser.add_argument('--resume', type=str, default='/home/work/froth_images_data/udsd/xiaorongshiyan/2023.08.09-xiaorongshiyan/results/trial/00350.pth',help='specified the dir of saved models for resume the training')
    self.parser.add_argument('--gpu', type=int, default=0, help='gpu')
    self.parser.add_argument('--lambdaB', type=float, default=0.5, help='perceptual loss weight for B')
    self.parser.add_argument('--lambdaI', type=float, default=30, help='color loss weight')
